...
const AddShow = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
              ...
              <div className='relative rounded-lg overflow-hidden'>
                ...
                <div className='text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0'>
                  <p className='flex items-center gap-1 text-gray-400'>
                    <StarIcon className='ww-4 h-4 text-primary fill-primary ' />
      ...
      {/* date & time selection    */}
      <div className='mt-6'>
        <label className='block text-sm font-medium mb-2 bo'>Select Date and Time</label>
        <div className='inline-flex gap-5 rounded-md border border-gray-600 p-1 pl-3'>
