...
import { Flag, Frame, PlayCircleIcon } from 'lucide-react'
...
const Trailer = () => {
    ...
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
            <p className='text-gray-300 font-medium text-lg max-w-[960px] mx-auto'>Xem Trước</p>

            <div className='relative mt-6'>
                <BlueC top='-100px' right='-100px' />
                {/* <ReactPlayer url={currentTrailer.videoUrl} controls={false}
                    className='mx-auto max-w-full' width='960px' height='540px' /> */}
                <iframe src='https://www.youtube.com/embed/Pez37wmUaQM' className='mx-auto max-w-full rounded-2xl' width='960px' height='540px'></iframe>
            </div>
