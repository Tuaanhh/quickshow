...
const HeroSection = () => {
    ...
    bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
            ...
            <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-110'>Vệ Binh <br /> Dải Ngân Hà</h1>
            ...
            {/* <p></p> */}
            <button onClick={()=>Navigate('/')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full  '>
