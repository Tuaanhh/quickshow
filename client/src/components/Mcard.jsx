  ...
  return (
    ...
    hover:-translate-y-1 transition duration-300 w-66'>
      <img onClick={() => { navigate(`/movies/${movie._id}`); scrollTo(0, 0) }}
        src={movie.backdrop_path} alt="" className='rounded-lg h-52 w-full object-cover object-bottom cursor-pointer' />
      ...
      <div className='flex items-center justify-between mt-4 pb-3 '>
        ...
        <StarIcon className='W-4 h-4 text-primary fill-primary'/> {movie.vote_average.toFixed(1)}</p>
