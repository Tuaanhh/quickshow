...
const Nabvar = () => {
  ...
  return (
    ...
    justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      max-md:justify-center gap-8 min-md:px-8 py-2 max-md:h-screen
        ...
        transition rounded-full font-medium cursor-pointer'>Login</button>
          ...
          <UserButton>
            <UserButton.MenuItems>
              <UserButton.Action label= "My Booking" labelIcon={<TicketPlus width={15} className='translate-y-[-3px]'/>}
              onClick={() => naviagte('/my-booking')}/>
            </UserButton.MenuItems>
          </UserButton>
        )
